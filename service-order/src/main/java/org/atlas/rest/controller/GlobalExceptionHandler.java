...
import org.atlas.rest.exception.InformationNotFoundException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<CustomErrorResponse> catchOrderNotFoundException(OrderNotFoundException ex) {
        log.error(ex.getMessage(), ex);
    ...
    public ResponseEntity<CustomErrorResponse> catchInformationNotFoundException(InformationNotFoundException ex) {
        log.error(ex.getMessage(), ex);
        return new ResponseEntity<>(new CustomErrorResponse(HttpStatus.NOT_FOUND, ex.getMessage()),
                HttpStatus.NOT_FOUND);
    }
